...
execute if score @s rune_roll <= #draconic rune_chances run tag @s add won_rune

execute if entity @s[tag=won_rune] run loot give @s loot trail_runes:runes/draconic
