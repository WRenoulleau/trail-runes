...
# No Boots Equipped
$execute unless items entity @s armor.feet * at @s run loot spawn ~ ~ ~ loot trail_runes:runes/$(id)
execute unless items entity @s armor.feet * run playsound entity.villager.no player @s ~ ~ ~ 1 1
...
$execute if entity @s[tag=can_apply_rune] if items entity @s armor.feet *[custom_data~{rune_id:"$(id)"}] at @s run loot spawn ~ ~ ~ loot trail_runes:runes/$(id)
$execute if entity @s[tag=can_apply_rune] if items entity @s armor.feet *[custom_data~{rune_id:"$(id)"}] run playsound entity.villager.no player @s ~ ~ ~ 1 1
...
execute if entity @s[tag=can_apply_rune] if items entity @s armor.feet *[custom_data~{has_rune:true}] run function trail_runes:api/extract_rune
